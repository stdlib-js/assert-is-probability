...
```javascript
import isProbability from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-probability@v0.2.3-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { isObject, isPrimitive } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-probability@v0.2.3-esm/index.mjs';
```
